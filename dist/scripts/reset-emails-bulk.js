...
async function main() {
    ...
    if (uniqueIds.length !== COMPANY_IDS.length) {
        console.warn(`Aviso: havia IDs duplicados na lista; processando ${uniqueIds.length} únicos.`);
    }
    console.log(`Esta operação apaga e recria ${uniqueIds.length} contas no domínio ${CPANEL_DOMAIN} (cPanel + BD).`);
...
//# sourceMappingURL=reset-emails-bulk.js.map