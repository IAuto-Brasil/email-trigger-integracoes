...
function readIntInRange(envName, fallback, min, max) {
...
exports.config = {
    ...
    receiveLeadUrl: process.env.RECEIVE_LEAD_URL ??
     ...
     */
    monitoring: {
        perAccountImapTimeoutMs: readIntInRange("IMAP_PER_ACCOUNT_TIMEOUT_MS", 20 * 60 * 1000, 60000, 2 * 60 * 60 * 1000),
        imapFullCycleRetryMax: readIntInRange("IMAP_FULL_CYCLE_RETRIES", 2, 1, 5),
        imapFullCycleRetryDelayMs: readIntInRange("IMAP_FULL_CYCLE_RETRY_DELAY_MS", 4000, 500, 120000),
        imapConnectMaxAttempts: readIntInRange("IMAP_CONNECT_MAX_ATTEMPTS", 4, 1, 10),
        imapConnectBaseDelayMs: readIntInRange("IMAP_CONNECT_BASE_DELAY_MS", 2000, 500, 120000),
    },
};
